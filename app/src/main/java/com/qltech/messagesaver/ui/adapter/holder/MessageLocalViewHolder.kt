...
import kotlinx.android.synthetic.main.item_message_local.*

class MessageLocalViewHolder(itemView: View) : RecyclerAdapterBase.ViewHolder<Message>(itemView) {

    companion object {
        const val LAYOUT_RES = R.layout.item_message_local
    }
    ...
    init {
        ...
        send.setOnClickListener {
            ...
            lastData?.let { data ->
                onMessageClickListener?.onShareBtnClick(data)
            }
        }
